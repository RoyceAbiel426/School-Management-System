...
const CoachLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await coachAuth.login(formData);
      login(response.coach, ROLES.COACH, response.token);
    ...
    <AuthLayout>
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-600">Sign in to your coach account</p>
        </div>
